...
data = pd.read_csv('https://raw.githubusercontent.com/'
                   'renansantosmendes/lectures-cdas-20'
                   '23/master/fetal_health.csv')

# # 3 - Preparando o dado antes de iniciar o treino do modelo# %%
features_to_remove = data.columns[7:]
X = data.drop(features_to_remove,
              axis=1)
y = data["fetal_health"]
...
os.environ['MLFLOW_TRACKING_PASSWORD'] = '018b6c087f3bba30a88adfb' \
                                            '1988cf53f1f42c4e5'
mlflow.set_tracking_uri(
    'https://dagshub.com/suport.develop/mlops-puc-180923.mlflow'
    )
